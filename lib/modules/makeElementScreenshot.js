...
exports.default = function makeElementScreenshot(browser, elementSelector) {
  ...
  var elements, boundingRects, boundingRect, base64Image;
  return _regenerator2.default.async(function makeElementScreenshot$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 3:
          _context.next = 5;
          return _regenerator2.default.awrap((0, _getElements2.default)(elementSelector));

        case 5:
          elements = _context.sent;
          _context.next = 8;
          return _regenerator2.default.awrap(browser.execute(_getBoundingRects2.default, elements));
