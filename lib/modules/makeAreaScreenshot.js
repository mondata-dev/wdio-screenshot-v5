...
exports.default = function makeAreaScreenshot(browser, startX, startY, endX, endY) {
  ...
  var screenDimensions, screenDimension, screenshotStrategy, uuid, dir, cropImages, screenshotPromises, loop, _screenshotStrategy$g, x, y, indexX, indexY, cropDimensions, filePath, base64Screenshot, _ref, _ref2, mergedBase64Screenshot;
    ...
    while (1) {
      switch (_context4.prev = _context4.next) {
        ...
        case 25:
          ...
          _context4.next = 30;
          return _regenerator2.default.awrap(browser.saveScreenshot(filePath));
