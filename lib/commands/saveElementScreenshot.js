...
function isElementOrSelector(obj) {
  return (0, _isString3.default)(obj) || (0, _isArray3.default)(obj) || (0, _isObject3.default)(obj) && obj.hasOwnProperty("selector");
}
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          if (isElementOrSelector(fileName) && (0, _isPlainObject3.default)(elementSelector) && (0, _isUndefined3.default)(options)) {
            options = elementSelector;
            elementSelector = fileName;
            fileName = undefined;
          } else if (isElementOrSelector(fileName) && (0, _isUndefined3.default)(elementSelector)) {
            elementSelector = fileName;
            fileName = undefined;
          }
